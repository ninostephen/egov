...
#keys table
CREATE TABLE `egov`.`userKeys` ( `userid` VARCHAR(70) NOT NULL , `type` VARCHAR(10) NOT NULL , `publicKey` VARCHAR(300) NOT NULL UNIQUE, `creation` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , `deprication` DATE NOT NULL );
