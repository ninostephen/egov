...
#keys table
CREATE TABLE `egov`.`userKey` ( `sno` INT(4) UNSIGNED NOT NULL , `userid` VARCHAR(70) NOT NULL , `type` VARCHAR(10) NOT NULL , `publilcKey` VARCHAR(300) NOT NULL UNIQUE, `creation` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , `deprication` DATE NOT NULL );

#Request table
CREATE TABLE `egov`.`request` ( `requestID` VARCHAR(40) NOT NULL PRIMARY KEY, `userid` VARCHAR(70) NOT NULL , `unit` VARCHAR(10) NOT NULL , `subject` VARCHAR(50) NOT NULL , `body` TEXT NOT NULL , `submisionDate` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , `status` VARCHAR(10) NOT NULL , `comments` TEXT NOT NULL , `integrity` VARCHAR(10) NOT NULL);
